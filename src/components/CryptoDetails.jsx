...
const CryptoDetails = () => {
  ...
  if (error) return <div>Error loading crypto details.</div>;
      ...
      <Col className="stats-container">
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overview showing additional statistics of {cryptoDetails.name}, such as the number of markets and exchanges.</p>
          </Col>
